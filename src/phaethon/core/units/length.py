...
@_axiom.bound(min_val=0, msg="Length cannot be a negative value.", abstract=True)
...
class Gigameter(LengthUnit):
    symbol = "Gm"
    aliases = ["gm", "gigameter", "gigameters", "gigametre"]
    base_multiplier = 1e9

class Terameter(LengthUnit):
    symbol = "Tm"
    aliases = ["tm", "terameter", "terameters", "terametre"]
    base_multiplier = 1e12

class Petameter(LengthUnit):
    symbol = "Pm"
    aliases = ["pm", "petameter", "petameters", "petametre"]
    base_multiplier = 1e15

class Exameter(LengthUnit):
    symbol = "Em"
    aliases = ["em", "exameter", "exameters", "exametre"]
    base_multiplier = 1e18

class Zettameter(LengthUnit):
    symbol = "Zm"
    aliases = ["zm", "zettameter", "zettameters", "zettametre"]
    base_multiplier = 1e21

class Yottameter(LengthUnit):
    symbol = "Ym"
    aliases = ["ym", "yottameter", "yottameters", "yottametre"]
    base_multiplier = 1e24

class Ronnameter(LengthUnit):
    symbol = "Rm"
    aliases = ["rm", "ronnameter", "ronnameters", "ronnametre"]
    base_multiplier = 1e27

class Quettameter(LengthUnit):
    symbol = "Qm"
    aliases = ["qm", "quettameter", "quettameters", "quettametre"]
