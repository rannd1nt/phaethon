...
from phaethon import axiom, C, units
...
class CompressedCubicMeter(units.CubicMeter):
    symbol = "m³_comp"
...
print(f"Normal Volume (1 ATM) : {normal_gas.to(units.CubicMeter).mag:.1f} m³")
...
print(f"Compressed    (5 ATM) : {compressed_gas.to(units.CubicMeter).mag:.1f} m³")