...
speed_mph = units.MilePerHour(raw_speed_mph)
pressure_psi = units.PSI(raw_tire_pressure_psi)

# 2. Vectorized conversion to FIA Metric Standards
speed_kph = speed_mph.to(units.KilometerPerHour).mag
pressure_bar = pressure_psi.to(units.Bar).mag
